...
#pragma region factory
    void setup_factory(aoc::ExerciseFactory& factory) {
        ...
        factory.prepare("2023", "day3", [](aoc::ExerciseFactory::PosArgs& args, aoc::ExerciseFactory::OptArgs& options) { return std::make_unique<Ex2023d3>(); });
    }
